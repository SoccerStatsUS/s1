...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CareerStat'
        db.create_table('stats_careerstat', (
        ...
        db.send_create_signal('stats', ['CareerStat'])


    def backwards(self, orm):
        
        # Deleting model 'CareerStat'
        db.delete_table('stats_careerstat')
