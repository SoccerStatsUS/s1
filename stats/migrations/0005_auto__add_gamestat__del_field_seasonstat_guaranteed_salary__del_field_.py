...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stats_gamestat', (
            ...
            ('corner_kicks', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('crosses', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal('stats', ['GameStat'])

        # Deleting field 'SeasonStat.guaranteed_salary'
        db.delete_column('stats_seasonstat', 'guaranteed_salary')

        # Deleting field 'SeasonStat.base_salary'
        db.delete_column('stats_seasonstat', 'base_salary')

        # Adding field 'SeasonStat.shutouts'
        db.add_column('stats_seasonstat', 'shutouts', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SeasonStat.goals_allowed'
        db.add_column('stats_seasonstat', 'goals_allowed', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SeasonStat.shots_faced'
        db.add_column('stats_seasonstat', 'shots_faced', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SeasonStat.saves'
        db.add_column('stats_seasonstat', 'saves', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SeasonStat.penalties_allowed'
        db.add_column('stats_seasonstat', 'penalties_allowed', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SeasonStat.penalties_faced'
        db.add_column('stats_seasonstat', 'penalties_faced', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'GameStat'
        db.delete_table('stats_gamestat')

        # Adding field 'SeasonStat.guaranteed_salary'
        db.add_column('stats_seasonstat', 'guaranteed_salary', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SeasonStat.base_salary'
        db.add_column('stats_seasonstat', 'base_salary', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'SeasonStat.shutouts'
        db.delete_column('stats_seasonstat', 'shutouts')

        # Deleting field 'SeasonStat.goals_allowed'
        db.delete_column('stats_seasonstat', 'goals_allowed')

        # Deleting field 'SeasonStat.shots_faced'
        db.delete_column('stats_seasonstat', 'shots_faced')

        # Deleting field 'SeasonStat.saves'
        db.delete_column('stats_seasonstat', 'saves')

        # Deleting field 'SeasonStat.penalties_allowed'
        db.delete_column('stats_seasonstat', 'penalties_allowed')

        # Deleting field 'SeasonStat.penalties_faced'
        db.delete_column('stats_seasonstat', 'penalties_faced')
