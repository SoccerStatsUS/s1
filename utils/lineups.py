...
from soccer.lineups.models import Game, GameAppearance, GoalRecord
...
def delete_model(model, max=100000):
    print "%s total" % model.objects.count()
    i = 0
...
def delete_items():
    delete_model(GoalRecord)
    delete_model(GameAppearance)
