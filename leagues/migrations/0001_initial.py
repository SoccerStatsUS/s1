...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'League'
        db.create_table('leagues_league', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('confederation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='leagues', to=orm['international.Confederation'])),
        ))
        db.send_create_signal('leagues', ['League'])


    def backwards(self, orm):
        
        # Deleting model 'League'
        db.delete_table('leagues_league')
