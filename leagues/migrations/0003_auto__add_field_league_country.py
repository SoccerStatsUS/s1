...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'League.country'
        db.add_column('leagues_league', 'country', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['places.Country']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'League.country'
        db.delete_column('leagues_league', 'country_id')
