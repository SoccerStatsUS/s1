...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GameAppearance.team'
        db.add_column('lineups_gameappearance', 'team', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teams.Team']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GameAppearance.team'
        db.delete_column('lineups_gameappearance', 'team_id')
