...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GameGoal.penalty'
        db.add_column('lineups_gamegoal', 'penalty', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GameGoal.penalty'
        db.delete_column('lineups_gamegoal', 'penalty')
