...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.mls_slug'
        db.add_column('players_person', 'mls_slug', self.gf('django.db.models.fields.CharField')(default='', max_length=250), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.mls_slug'
        db.delete_column('players_person', 'mls_slug')
