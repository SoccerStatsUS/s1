...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('teams_team', 'nickname')


    def backwards(self, orm):
        
        # We cannot add back in field 'Team.nickname'
        raise RuntimeError(
            "Cannot reverse this migration. 'Team.nickname' and its values cannot be restored.")
